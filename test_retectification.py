...
def undistort_fisheye(image_path, K, D):
    ...
    new_camera_matrix0, roi0 = cv2.getOptimalNewCameraMatrix(K, D, (w, h), 0, (w, h))
    new_camera_matrix1, roi1 = cv2.getOptimalNewCameraMatrix(K, D, (w, h), 1, (w, h))
    ...
    undistorted_img_undis_1 = cv2.undistort(img, K, D, None, new_camera_matrix1)
    ...
    x, y, w, h = roi0
    undistorted_img_undis_0_croped = undistorted_img_undis_0[y:y+h, x:x+w]
    x, y, w, h = roi1
    undistorted_img_undis_1_croped = undistorted_img_undis_1[y:y+h, x:x+w]
    ...
    cv2.imshow('Rectified Image (undistort 1)', cv2.resize(undistorted_img_undis_1, (424, 400)))
    cv2.imshow('Rectified Image (undistort 0 cropped)', cv2.resize(undistorted_img_undis_0_croped, (424, 400)))
    cv2.imshow('Rectified Image (undistort 1 cropped)', cv2.resize(undistorted_img_undis_1_croped, (424, 400)))
